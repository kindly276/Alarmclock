...
public class MusicService extends Service implements
	...
	public void onCreate() {
		super.onCreate();
		//
		// mPlayer = MediaPlayer.create(this, R.raw.roicungmatnhau);
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		try {
			mPlayer = MediaPlayer.create(this, alarmModel.alarmTone);
//			mPlayer.setDataSource(this, alarmModel.alarmTone);
